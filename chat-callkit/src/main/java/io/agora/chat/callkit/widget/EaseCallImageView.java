...
public class EaseCallImageView extends AppCompatImageView {
    ...
    public EaseCallImageView(Context context) {
        super(context);
        init(context, null);
    }

    public EaseCallImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EaseCallImageView(Context context, AttributeSet attrs, int defStyleAttr) {
