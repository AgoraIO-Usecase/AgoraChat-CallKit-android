...
public class EaseCallStatusBarCompat {
    ...
    public static void setLightStatusBar(Activity activity, boolean dark) {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            switch (EaseCallRomUtils.getLightStatusBarAvailableRomType()) {
                case EaseCallRomUtils.AvailableRomType.MIUI :
                    setMIUISetStatusBarLightMode(activity, dark);
                    break;
                case EaseCallRomUtils.AvailableRomType.FLYME :
                    setFlymeLightStatusBar(activity, dark);
                    break;
                case EaseCallRomUtils.AvailableRomType.ANDROID_NATIVE :
    ...
    public static boolean setMIUISetStatusBarLightMode(Activity activity, boolean dark) {
        ...
        if (window != null) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && EaseCallRomUtils.isMiUIV7OrAbove()) {
                    if (dark) {
